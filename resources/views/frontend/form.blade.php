    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 slider1">
                ...
                <h5 class="text-center">Height: <span style="color: #FFA300; font-weight: bold;" id="feet_output"></span> Feet <span style="color: #FFA300; font-weight: bold;" id="inches_output"></span> Inch</h5>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-12 text-center">
        ...
        <div class="row">
            <div class="col-12 slider1">
                ...
                <h5 class="text-center"><span style="color: #FFA300; font-weight: bold;" id="weight_output"></span> KG</h5>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 slider1" style="max-width: 47%;">
                ...
                <h5 class="text-center"><span id="neck_size_output" style="color: #FFA300; font-weight: bold;"></span> Inches</h5>
            </div>
...
<section id="dietary_restriction">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center" style="margin-top: 2rem;">
                <h2 style="color: #FFA300;">DO YOU HAVE ANY <span style="color: #003981;">DIETARY RESTRICTION?</span></h2>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-12 slider1" style="max-width: 47%;">
                <div class="slidecontainer" style="margin-top: 5rem;">
                    <!-- <p>Inches</p> -->
                    <input style="width: 65%;" type="range" min="1" max="100" value="50" class="slider" id="waistsize">
                </div>
                <br>
                <h5 class="text-center"><span id="waist_size_output" style="color: #FFA300; font-weight: bolder;" ></span> inches</h5>
            </div>
...
<section id="body_shape">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center" style="margin-top: 2rem;">
                <h2 style="color: #FFA300;">WHAT IS YOUR <span style="color: #003981;">CURRENT BODY SHAPE?</span></h2>
            </div>
        </div>
...
<section id="habits">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center" style="margin-top: 2rem;">
                <h2 style="color: #003981;">DO YOU HAVE ANY <span style="color: #FFA300;">OF THESE HABITS?</span></h2>
            </div>
        </div>
...
<section id="medical_condition">
    <div class="container my-4">
        <div class="row">
            <div class="col-12 text-center">
                <h2 style="color: #003981;">CURRENT MEDICAL <span style="color: #FFA300;">CONDITION</span></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12 slider1" style="max-width: 60%; margin: auto;">
                <div class="bp">
                    <div class="slidecontainer" style="margin-top: 5rem;">
                        <p>Blood Pressure</p>
                        <input style="width: 65%;" type="range" min="1" max="100" value="50" class="slider" id="myRange">
                    </div>
                    <h5 class="text-center">Blood Pressure: <span id="demo"></span></h5>
                </div>
                <div class="bs">
                    <div class="slidecontainer" style="margin-top: 2rem;">
                        <p>Blood Suger</p>
                        <input style="width: 65%;" type="range" min="1" max="100" value="50" class="slider" id="myRange">
                    </div>
                    <h5 class="text-center">Blood Suger: <span id="demo"></span></h5>
                </div>
            </div>

            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="radio_buttons12 mt-5">
                    <label class="custom_radio12">
                        <input type="radio" name="radio12">
                        <span class="radio_btn12">
                <div class="radio_img4">
                  <img src="{{asset('assets/frontend')}}/img/form/8.jpg" alt="60'S">
                </div>
                <h5>NOT SURE</h5>
        ...
        <div class="food_allergy py-5">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="radio_buttons14">
                        <label class="custom_radio14">
                            <input type="radio" name="sea_food">
                            <span class="radio_btn14">
                <div class="radio_img14">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="radio_buttons14">
                        <label class="custom_radio14">
                            <input type="radio" name="eggplants">
                            <span class="radio_btn14">
                <div class="radio_img14">
